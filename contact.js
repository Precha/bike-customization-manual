/* ============================================================
   ...
   編輯此檔案以更新「一般諮詢及訂單相關問題」的聯絡人表格。
   每筆資料為一個物件，包含 market、name、email 三個欄位。
   新增、刪除或調整順序後，重新整理瀏覽器即可生效。
   ============================================================ */
...
window.CONTACTS = [
  ...
  { market: 'GW',                  name: 'Katarzyna Kurdej',     email: 'kkurdej@giant-polska.com.pl'    },
];
